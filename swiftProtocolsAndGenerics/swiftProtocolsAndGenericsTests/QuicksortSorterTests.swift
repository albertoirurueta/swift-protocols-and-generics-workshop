...
class QuicksortSorterTests: XCTestCase {
    ...
    func testSortWithRange() {
        for _ in 1...QuicksortSorterTests.times {
            let length = QuicksortSorterTests.minLength +
                Int(arc4random_uniform(UInt32(
                    QuicksortSorterTests.maxLength -
                        QuicksortSorterTests.minLength)))
            ...
            for i in 0..<length {
                array[i] = QuicksortSorterTests.minValue +
                    Int(arc4random()) % (QuicksortSorterTests.maxValue -
                        QuicksortSorterTests.minValue)
            }
